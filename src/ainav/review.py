...
def deep_dive(*, probe: bool = False) -> str:
    ...
    lines += [
        ...
        "",
        f"**Industry drawer.** {industry_drawer['lede']} {industry_drawer['site']} {industry_drawer['note']} Sit / maps / attach / refuse. Maps claimed=false. Papers are not filings. Room 1 is books. Room 2 is refuse. Honest zeros. Refuse is visible. Every refuse clicks. Catalog is the message. Complete industry drawer.",
        "",
