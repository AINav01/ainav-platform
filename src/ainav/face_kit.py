...
def public_llms() -> str:
    ...
    lines = [
        ...
        face["thesis"],
        "",
        "Honest industry certify sits on #packs. Five industry areas: books, sales deepen, keep, libraries, repositories. Need and why sit with standard inclusions and upsells. Packs are not SKUs. Industry certify is not launch. A 10/10+ quality check is not launch.",
