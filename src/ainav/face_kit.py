...
def public_llms() -> str:
    ...
    lines = [
        ...
        face["thesis"],
        "",
        "Honest industry certify sits on #packs. Five industry areas: books, sales deepen, keep, libraries, repositories. Walk the five areas. Need and why sit with standard inclusions and upsells. Packs are not SKUs. Industry certify is not launch. A 10/10+ quality check is not launch.",
...
def public_search() -> dict[str, Any]:
    ...
    records = [
        ...
        },
        {
            ...
            "text": "Sit-down industry drawer. Sit Dynamics BC treasury. Domestic and international maps claimed=false. White papers are not filings. Included versus upsell. Libraries and repositories are not SKUs. Room 1 is books. Room 2 is refuse. Five industry areas on #packs tell the need and the why. Walk the five areas. Fully operable industry drawer. Complete industry drawer. Every refuse clicks. Catalog is the message. Honest zeros. Refuse is visible. Not a crypto product. Not a /industry route.",
        },
        {
            "id": "packs",
            "title": "Honest industry certify",
            "href": "index.html#packs",
            "text": "Honest industry certify on #packs. Five industry areas: books, sales deepen, keep, libraries, repositories. Walk the five areas. Need and why. Standard inclusions and upsells. Packs are not SKUs. Industry certify is not launch. A 10/10+ quality check is not launch. Credit, inventory, and pricing stay unpaired.",
        },
        {
            "id": "industry-books",
            "title": "Industry books",
            "href": "index.html#industry-area-books",
            "text": "Room 1 books. Need: an unauthorized Business Central journal. Why: controllers already have SOD. They do not have Job C in front of the write. Not a named vertical. Packs are not SKUs. A 10/10+ quality check is not launch.",
        },
        {
            "id": "industry-sales",
