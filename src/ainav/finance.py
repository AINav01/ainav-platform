...
def scenarios() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            "id": "l1_padm_ip_keep",
            "name": "One controller — L1, P-ADM, IP keep",
            "if": "One controller buys L1, attaches P-ADM, then attaches industry.ip_keep for reserved-work notice.",
            "skus": ["L1", "P-ADM"],
            "packs": ["industry.ip_keep"],
            "n": 1,
            "min": l1_min + keep_min + _desks("industry.ip_keep")[0],
            "max": l1_max + keep_max + _desks("industry.ip_keep")[1],
        },
        {
