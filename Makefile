...
regen:
	...
	python3 -c "from ainav.microsoft.build import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/build.json
	...
	python3 -c "from ainav.copilot_studio import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/studio.json
	python3 -c "from ainav.honest_connect import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/connect.json
	python3 -c "from ainav.honest_operate import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/operate.json
	python3 -c "from ainav.honest_path import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/path.json
	python3 -c "from ainav.honest_production import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/production.json
	python3 -c "from ainav.honest_remainder import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/remainder.json
	python3 -c "from ainav.honest_ten import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/ten.json
	python3 -c "from ainav.honest_protect import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/protect.json
	python3 -c "from ainav.honest_hold import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/hold.json
	python3 -c "from ainav.honest_close import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/close.json
	python3 -c "from ainav.honest_join import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/join.json
	python3 -c "from ainav.honest_better import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" > institute/better.json
...
plan-check:
	...
	python3 -c "from ainav.microsoft.build import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/build.json -
	...
	python3 -c "from ainav.copilot_studio import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/studio.json -
	python3 -c "from ainav.honest_connect import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/connect.json -
	python3 -c "from ainav.honest_operate import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/operate.json -
	python3 -c "from ainav.honest_path import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/path.json -
	python3 -c "from ainav.honest_production import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/production.json -
	python3 -c "from ainav.honest_remainder import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/remainder.json -
	python3 -c "from ainav.honest_ten import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/ten.json -
	python3 -c "from ainav.honest_protect import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/protect.json -
	python3 -c "from ainav.honest_hold import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/hold.json -
	python3 -c "from ainav.honest_close import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/close.json -
	python3 -c "from ainav.honest_join import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/join.json -
	python3 -c "from ainav.honest_better import public_review; import json; print(json.dumps(public_review(), indent=2, sort_keys=True))" | diff -q institute/better.json -
...
gold: plan-check
	python3 -m pytest -q --cov=agent_gov --cov=ainav --cov-report=term-missing --cov-fail-under=99.5
