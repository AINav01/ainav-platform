...
- Audit: internal audit × regulator archive × failure to comply × Room 1 books × Room 2 refuse. Same dashboard. Not 17a-4. Not a crypto product.
...
- **People / Notify** — licensed_not_wired. Teams is licensed. Team.ReadBasic.All is Granted. A chat is not a seat. Graph notify is not wired. Graph Writes are owner-revoked. Do not add Write.
- **Security / Compliance** — licensed_not_wired. E7 licenses exist. Sites.Read.All, SecurityIncident.Read.All, and RoleEligibilitySchedule.Read.Directory are Granted. Complements are not SKUs. PIM activation is not dual admit. LAW is not Sentinel. Graph Writes are owner-revoked. Do not add Write.
...
- Cases: kit.bc.journal, kit.icfr.unauthorized_gl
