...
30 August 2026. Confidential. For Cynthia Hodnett. From James Hodnett. Release 2.73.0.
...
The admit plane is in code. Gold floor is 95 percent. The Floor sits catalog view_shows, the provision spine, and the owner board packet. There is a real Business Central Sandbox company named AINav and a sandbox journal AINAV-L1. Those seats were lab operator identities, not two named treasury humans. The Institute is hosted on Azure and is not launched. Production is blocked. Named customers: none. Recognized revenue: none. Signed L1: none.
