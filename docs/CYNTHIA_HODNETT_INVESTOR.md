...
30 August 2026. Confidential. For Cynthia Hodnett. From James Hodnett. Release 3.22.0.
...
| U-DUAL | deepen | $20,000–$35,000 | annual |
...
| industry.second_record — Second-record keep | $5,000–$8,000 | A la carte P-ADM keep. Second record for examiners and the client's customers. Not the SoR first record. Not a certificate. Not LIVE_PIN_OK. |
| industry.board — Board / examiner keep | $5,000–$8,000 | A la carte P-ADM keep. Owner, board, and examiner pack: who admitted, freeze evidence, last sealed keep. Not a filing. Not a certificate. Not LIVE_PIN_OK. |
...
The vendor of the AI cannot credibly sit over that AI as the failsafe. Lockfile stays job_c. Gold is fail-closed. Catalog law refuses competitor SKUs. This is not a patent. This is not uncopyable. G12 stays open.
Insulation equation: independence × Job C lockfile × fail-closed gold × catalog law.

## Traction — honest

The admit plane is in code. Gold floor is 95 percent. Gold floor 99 was the floor. Gold floor 99.5 is now the floor after measured coverage. Live Cloudflare quality probe verified 301, apex 404 empty on Cloudflare edge, TLS 1.2+, and mail not Cloudflare anycast. Azure SWA is the development twin and the 2.82.0 review website. Owner recorded Automatic SSL/TLS Full (strict). Rocket Loader stays owner confirm. The Floor sits catalog view_shows, the provision spine, and the owner board packet. There is a real Business Central Sandbox company named AINav and a sandbox journal AINAV-L1. Those seats were lab operator identities, not two named treasury humans. The Institute twin is hosted on Azure and is not launched. Production is blocked. Named customers: none. Recognized revenue: none. Signed L1: none.
