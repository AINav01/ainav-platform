...
- Twin: The Institute has a digital twin. Development is Azure SWA. The public hostname is on Cloudflare and is empty. Gold 99 is the release floor. Authorization is owner-only. Cloudflare is the edge. Azure SWA is the twin. Apex 404 is not the Institute. A green check is not LIVE_PIN_OK. Not launch.
...
- Workflow: `.github/workflows/gold.yml`. Command: `make gold`. Coverage floor: 99.
