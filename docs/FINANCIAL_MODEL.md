# AINav, Inc. — catalog-list financial model
...
- **L1** — fixed_scope_project (engagement). 2–4 weeks
- **P-ADM** — annual_keep (year). L1 Acceptance Kit PASS
- **U-DUAL** — annual_deepen (year).
