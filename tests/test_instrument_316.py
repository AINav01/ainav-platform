...
def test_release_is_316_honest_ten():
    ...
    assert "Digital twin · 3.19.0" in twin
    assert "AINAV.Institute twin · 3.19.0" in twin
    ...
    assert "Application kit · 3.19.0" in kit
    assert "Release 3.19.0" in lost
    assert "3.16.0" not in lost
    assert "Ultimate control plane · 3.19.0" in plane
