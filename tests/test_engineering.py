...
def test_catalog_allows_recorded_missing_gold_workflow():
    ...
    cat["engineering"]["closed_in_tree"] = [
        ...
        if "gold" not in item.lower() or "2.72.0" in item or "2.78.0" in item or "2.79.0" in item or "2.80.0" in item or "2.81.0" in item or "2.82.0" in item or "2.83.0" in item or "2.84.0" in item or "2.85.0" in item or "2.86.0" in item or "2.87.0" in item or "2.88.0" in item
    ]
